      ...
      <View style={styles.card}>
        <View style={styles.header}>
          ...
          <View style={styles.headerTextContainer}>
            <Text style={styles.headerTextMain}>Devgenix</Text>
            <Text style={styles.headerTextBeside}>@blaine</Text>
            <Text style={styles.headerTextSecondary}>12 hrs Ago</Text>
          </View>
          <Entypo name="dots-three-horizontal" size={24} color="white" />
        </View>
        <Text style={styles.postcontent}>
          I’ve been working on this and I need someone to colllab with. Who’s
          in?
        </Text>
        <Image
        ...
        <View style={styles.footer}>
          <View style={styles.likeShareContainer}>
            ...
            <Text style={styles.likeShareCount}>2.1K</Text>
            <FontAwesome
              name="comment-o"
              size={24}
              color="white"
            ...
            />
            <Text style={styles.likeShareCount}>1K</Text>
          </View>
          <View style={styles.likeShareContainer}>
